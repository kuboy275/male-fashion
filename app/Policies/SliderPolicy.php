...
class SliderPolicy
{
    ...
    {
        return $user->hasPermission('slider_list');
    }
    ...
    {
        return $user->hasPermission('slider_create');
    }
    ...
    {
        return $user->hasPermission('slider_update');
    }
    ...
    {
        return $user->hasPermission('slider_delete');
    }
