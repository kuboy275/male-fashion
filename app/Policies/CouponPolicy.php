...
class CouponPolicy
{
    ...
    {
        return $user->hasPermission('coupon_list');
    }
    ...
    {
        return $user->hasPermission('coupon_create');
    }
    ...
    {
        return $user->hasPermission('coupon_update');
    }
    ...
    {
        return $user->hasPermission('coupon_delete');
    }
